...
<body>
<form class="balancedetail_form" name="balancedetail_form" 
	action="balanceUpdate" method="post"role="form">
	<div class="container col-sm-offset-3 col-sm-6" align="center">
		<div class="row" style="margin-top:20px">
			  <div align="center" style="font-size: 50px"><i class="fa fa-sign-in" aria-hidden="true"></i>${balance.yyyy}년 ${balance.vendname} 거래정보</div>
		</div>
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr style="text-align:center;">
						<th class="col-sm-2">월</th>
						<th class="col-sm-2">전월이월</th>
						<th class="col-sm-3">거래금액</th>
						<th class="col-sm-3">지불금액</th>
						<th class="col-sm-2">잔액</th>
					</tr>
				</thead>
				<tbody>
					<tr>
